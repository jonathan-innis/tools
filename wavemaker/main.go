...
func main() {
	...
	for {
		...
		logger.With("duration", duration.String()).Info("wave is active, will complete after duration")
		...
		logger.With("countdown", interval.String()).Info("completed wave, the next wave will start shortly")
